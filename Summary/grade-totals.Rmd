...
colors <- c(viridis(n = 1, begin = 0.8, end = 1), viridis(n = 1, begin = 0.6, end = 0.8), viridis(n = 1, begin = 0.4, end = 0.6)) #viridis(n = 1, begin = 0.2, end = 0.4), viridis(n = 1, begin = 0, end = 0.2))
